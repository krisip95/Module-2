...
public class MazeSolver15_1 {

	// 0 = wall
	// 1 = path
	// 2 = destination

	public static boolean solveMaze(Maze15_1 m) {
		Position15_1 p = m.start;
		m.path.push(p);
...
//					System.out.println("Moved down");
					m.path.push(new Position15_1(y + 1, x));
					continue;
				}
			}
...
//					System.out.println("Moved left");
					m.path.push(new Position15_1(y, x - 1));
					continue;
				}
			}
...
//			System.out.println("Moved back");
	...
	public static boolean isValid(int y, int x, Maze15_1 m) {
